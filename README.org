...
- [[#general-settings][General Settings]]
  ...
  - [[#text-filling][Text filling]]
  - [[#delete-all-on-backspace][Delete all on backspace]]
  - [[#emacsclient-executable][Emacsclient executable]]
  - [[#no-lockfiles][No lockfiles]]
  - [[#final-newline][Final newline]]
  - [[#pop-mark-on-repeat][Pop mark on repeat]]
  - [[#encryption][Encryption]]
  - [[#history][History]]
  - [[#bookmarks][Bookmarks]]
  - [[#custom-settings-in-tmp][Custom settings in /tmp]]
  - [[#enable-all-advanced-features][Enable all advanced features]]
  - [[#increase-message-logging-max][Increase message logging max]]
  - [[#more-extensive-apropos][More extensive apropos]]
...
- [[#complilation-related][Complilation related]]
  - [[#prefer-newer-over-compiled][Prefer newer over compiled]]
  - [[#place-point-after-complilation-error][Place point after complilation error]]
  - [[#ensure-init-files-are-byte-compiled][Ensure init files are byte compiled]]
  - [[#recompile-config][Recompile config]]
  - [[#auto-recompile-emacs-lisp][Auto recompile Emacs Lisp]]
  - [[#make-compilation-buffers-more-colorful][Make compilation buffers more colorful]]
...
- [[#emacs-built-in-package-configuration][Emacs built in package configuration]]
