...
* [[https://github.com/hlissner/doom-emacs/blob/develop/docs/faq.org#how-does-doom-start-up-so-quickly][Doom]] startup speed hacks
...
** Byte Compile
   ...
   #+begin_src emacs-lisp
     ...
     (add-hook 'after-save-hook 'ts-auto-byte-compile)
