...
#+begin_src emacs-lisp
  (defun ts-setup-emacs-gui ()
    ...
    (cond ((eq system-type 'window-nt) (set-frame-font "Cascadia Mono 10" nil t))
          ((eq system-type 'darwin) (set-frame-font "Monaco 10" nil t))
...
(add-hook 'prog-mode-hook 'semantic-decorations-mode)
#+end_src
