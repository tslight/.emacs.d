...
# eval: (add-hook 'org-babel-post-tangle-hook (lambda () (byte-recompile-file early-init nil 0)) nil t)
# eval: (add-hook 'org-babel-post-tangle-hook (lambda () (byte-recompile-file init-file nil 0)) nil t)
# End:
