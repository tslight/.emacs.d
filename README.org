...
Quickest way to get setup is to back up your current config, then clone this
repo to replace it:

#+begin_src shell :tangle no
  mv ~/.emacs.d{,.bak} && git clone https://github.com/tslight/.emacs.d ~/.emacs.d
#+end_src

*WARNING: JUST VISITING THIS FILE IN EMACS WILL OVERWRITE YOUR CONFIG!*

This is because I have added the following ~eval~ elisp snippet [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Specifying-File-Variables.html][file variables]]
at the bottom of this file:

#+begin_src emacs-lisp :tangle no
  (setq init-file (expand-file-name "init.el" user-emacs-directory))
  (setq early-init (expand-file-name "early-init.el" user-emacs-directory))
  (org-babel-tangle)
#+end_src
