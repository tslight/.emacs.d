...
#+begin_src emacs-lisp :tangle (if (version< emacs-version "27") "no" "yes")
...
#+begin_src emacs-lisp :tangle (if (version< emacs-version "28") "yes" "no")
  ;;;###autoload
...
#+begin_src emacs-lisp :tangle (if (version< emacs-version "28") "no" "yes")
  (unless (version< emacs-version "28")
