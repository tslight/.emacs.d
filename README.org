...
- [[#emacs-configuration-with-no-packages][Emacs configuration with no packages]]
  ...
  - [[#windows][Windows]]
    ...
    - [[#shift-current-line-to-top-of-the-window][Shift current line to top of the window]]
    - [[#shift-current-line-to-bottom-of-the-window][Shift current line to bottom of the window]]
    ...
    - [[#custom-window-function-keybindings][Custom window function keybindings]]
    - [[#builtin-window-function-keybindings][Builtin window function keybindings]]
    - [[#ctrl-x-4-map-bindings][Ctrl-x 4 map bindings]]
...
*** Shift current line to top of the window
...
*** Shift current line to bottom of the window
...
*** Custom window function keybindings
...
*** Builtin window function keybindings
